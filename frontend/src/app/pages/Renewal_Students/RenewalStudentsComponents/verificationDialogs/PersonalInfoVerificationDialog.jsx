...
function PersonalInfoVerificationDialog({ isOpen, onClose, onConfirm }) {
      ...
      <AlertDialogOverlay>
        <AlertDialogContent>
          <AlertDialogHeader fontSize="lg" fontWeight="bold">
            Confirm Personal Information Verification
          </AlertDialogHeader>
          <AlertDialogBody>
            Are you sure you want to mark this personal information as verified?
          </AlertDialogBody>
          <AlertDialogFooter>
...
export default PersonalInfoVerificationDialog;
